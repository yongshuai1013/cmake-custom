...
// NOTE (cmake-custom): upstream routes __NetBSD__ to LC_C_LOCALE, but zig's
// bundled NetBSD headers don't define it. Drop the NetBSD branch so NetBSD uses
// the __cloc() fallback (newlocale("C")) like OpenBSD/Linux.
